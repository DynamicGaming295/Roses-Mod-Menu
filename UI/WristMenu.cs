...
namespace Uptime.UI
{
    ...
    internal class WristMenu : MonoBehaviour
    {
        ...
        public static List<ButtonInfo> settingsbuttons = new List<ButtonInfo>
        {
            ...
            new ButtonInfo { buttonText = "Anti-Report", method =() => Mods.AntiReport(), enabled = false},
            new ButtonInfo { buttonText = "Anti-Ban <color=red>[D?]</color>", method =() => Mods.Antiban(), enabled = false, disableMethod =() => Mods.offantiban()},
            new ButtonInfo { buttonText = "Anti-Ban Status", method =() => Mods.AntibanStatus(), enabled = false},
        };
        //norma

        public static List<ButtonInfo> buttons = new List<ButtonInfo>
        {
            new ButtonInfo { buttonText = "Saftey Mods", method =() => Mods.Settings(), enabled = false},
            new ButtonInfo { buttonText = "Disconnect", method =() => Mods.Disconnect(), enabled = false},
            ...
            new ButtonInfo { buttonText = "Super Long Arms", method =() => Mods.SuperLongArms(), disableMethod =() => Mods.NormalArms(), enabled = false},
            new ButtonInfo { buttonText = "Fly", method =() => Mods.FlyMod(), enabled = false},
            new ButtonInfo { buttonText = "TTTPig Speed Boost", method =() => Mods.SpeedTTTPig(), enabled = false},
            new ButtonInfo { buttonText = "TP Gun", method =() => Mods.Tpgun(), enabled = false},
            new ButtonInfo { buttonText = "Ghost Monke", method =() => Mods.Ghostmonke(), enabled = false},
            new ButtonInfo { buttonText = "Head Spin", method =() => Mods.HeadSpin(), enabled = false},
        ...
        public static Color FirstColor = Color.magenta;
        public static Color SecondColor = ((Color.magenta + Color.white) / 2);
        public static Color purple = new Color32(125, 0, 125, 0);

        public static Color NormalColor = Color.magenta;

        public static Color ButtonColorDisable = Color.white;
        public static Color ButtonColorEnabled = Color.black;
        public static Color ButtonTextColorDisabled = Color.black;
        public static Color ButtonTextColorEnabled = Color.green;

        public static string MenuTitle = "Rose's Mod Menu By DynamicGaming295"; // Made by DynamicGaming295 with love!
